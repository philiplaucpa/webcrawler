...
public class CountTask extends RecursiveAction {
    ...
    public CountTask(final int maxDepth, final Clock clock, final Instant deadline,
    ...
    protected void compute() {
        ...
        final List<CountTask> subTasks = result.getLinks()
                .stream()
                .map(link -> new CountTask.Builder()
    ...
    public static final class Builder {
        ...
        public CountTask build() {
            return new CountTask(maxDepth, clock, deadline, url,
